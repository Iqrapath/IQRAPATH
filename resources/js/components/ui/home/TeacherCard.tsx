    ...
    <div className="relative p-4">
      <div className="relative overflow-hidden transform transition-transform hover:scale-105">
        ...
        <div className="relative">
          <img src="/assets/images/TeacherRectangle.png" alt="" className="w-full h-auto" />

          <div className="absolute inset-0 p-6 pb-0 flex flex-col items-center">
            <div className="w-32 h-32 rounded-full overflow-hidden mb-1 border-4 border-[#F3F3F3]">
        ...
        <div className="relative -mt-30 z-10 mx-auto w-[85%]">
          <img src="/assets/images/TeacherRectangle2.png" alt="" className="w-full h-auto" />
