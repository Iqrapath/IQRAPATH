...
interface GuardianLeftSidenavProps extends React.HTMLAttributes<HTMLDivElement> {}
...
export function GuardianLeftSidenav({ className, ...props }: GuardianLeftSidenavProps) {
    const { url } = usePage();
