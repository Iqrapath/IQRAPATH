...
interface StudentRightSidebarNavProps extends React.HTMLAttributes<HTMLDivElement> {}

export function StudentRightSidebarNav({ className, ...props }: StudentRightSidebarNavProps) {
