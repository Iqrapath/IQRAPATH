...
import { TeacherLeftSidenav } from './ui/teacher-left-sidenav';
...
export function TeacherHeader({ breadcrumbs = [], pageTitle }: TeacherHeaderProps) {
        ...
        <>
            <div className="border-sidebar-border/80 border-b bg-gradient-to-b from-[#FFF7E4]  to-[#FFF7E4]">
                <div className="mx-auto flex h-15 items-center px-4 md:max-w-7xl">
                        ...
                        <Sheet>
                            ...
                            <SheetContent side="left" className="bg-sidebar flex h-full w-64 flex-col items-stretch justify-between">
                                ...
                                <div className="flex-1 flex justify-center">
                                    <TeacherLeftSidenav className="h-full rounded-none w-full" />
                                </div>
                                        ...
                                        <DropdownMenuTrigger asChild>
                                            <Button variant="ghost" className="flex items-start space-x-1 rounded-full px-2 py-1">
                                                ...
                                                <div className=" flex flex-col items-start mr-2">
                                                    ...
                                                    <span className="text-xs text-gray-100">Teacher</span>
                                                </div>
                                            </Button>
                                        </DropdownMenuTrigger>
                    ...
                    <Link href="/teacher/dashboard" prefetch className="hidden sm:flex items-center space-x-2">
                        <AppLogo />
                    </Link>
