...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $user->role = 'student';
            $user->status = $request->input('user.status', 'active');
            ...
            $studentProfile->phone_number = $request->input('user.phone_number');
            $studentProfile->location = $request->input('user.location');
            ...
            $subscription->status = $request->input('subscription.status', 'Active');
        ...
        try {
            ...
            $response = [
                'user' => [
                    ...
                    'name' => $user->name,
                    'email' => $user->email,
                    'phone_number' => $user->studentProfile->phone_number ?? null,
                    'location' => $user->studentProfile->location ?? null,
                    'status' => $user->status,
